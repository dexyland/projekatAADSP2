...
int main(int argc, char* argv[])
{
	...
	printf("OUTPUT DATA: %d %d %d", outputWAVhdr.data.SubChunk2Size, outputWAVhdr.fmt.ByteRate, outputWAVhdr.fmt.BlockAlign);
	...
	//-------------------------------------------------	
	{
		...
		printf("\niNumSamples = %d", iNumSamples);

		// exact file length should be handled correctly...
		for (int i = 0; i<2*iNumSamples / BLOCK_SIZE; i++)
		{
