...
cline_167_0:			/* LN: 169 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x2)			# LN: 169 | 
	b0g = xmem[i0]; i0 += 1			# LN: 169, 169 | 
	b0h = xmem[i0]			# LN: 169 | 
	uhalfword(b0l) = (0x0)			# LN: 169 | 
	b0 = b0 >> 1			# LN: 169 | 
	a0 = (0x4000)			# LN: 169 | 
	a0 = a0 >> 1			# LN: 169 | 
	b0 - a0			# LN: 169 | 
...
cline_178_0:			/* LN: 180 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x2)			# LN: 180 | 
	a1g = xmem[i0]; i0 += 1			# LN: 180, 180 | 
	a1h = xmem[i0]			# LN: 180 | 
	uhalfword(a1l) = (0x0)			# LN: 180 | 
...
else_8:			/* LN: 184 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x2)			# LN: 188 | 
	a1g = xmem[i0]; i0 += 1			# LN: 188, 188 | 
	a1h = xmem[i0]			# LN: 188 | 
	uhalfword(a1l) = (0x0)			# LN: 188 | 
...
cline_303_0:			/* LN: 316 | CYCLE: 0 | RULES: () */ 
endif_12:			/* LN: 300 | CYCLE: 0 | RULES: () */ 
else_12:			/* LN: 300 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20b)			# LN: 316 | 
	a0 = 0			# LN: 316 | 
	xmem[i0] = a0h			# LN: 316 | 
for_3:			/* LN: 316 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x109)			# LN: 316 | 
	a0 = xmem[i0]			# LN: 316 | 
	uhalfword(a1) = (0x10)			# LN: 316 | 
	call (__div)			# LN: 316 | 
	i0 = i7 - (0x20b)			# LN: 316 | 
	a1 = xmem[i0]			# LN: 316 | 
	a1 - a0			# LN: 316 | 
	if (a >= 0) jmp (for_end_3)			# LN: 316 | 
cline_316_0:			/* LN: 318 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20c)			# LN: 318 | 
	a0 = 0			# LN: 318 | 
	xmem[i0] = a0h			# LN: 318 | 
	do (0x10), label_end_93			# LN: 318 | 
cline_318_0:			/* LN: 320 | CYCLE: 0 | RULES: () */ 
label_begin_93:			/* LN: 318 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 320 | 
	a0 = 0			# LN: 320 | 
	xmem[i0] = a0h			# LN: 320 | 
for_5:			/* LN: 320 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 320 | 
	a0 = xmem[i0]			# LN: 320 | 
	i0 = i7 - (0x106)			# LN: 320 | 
	a1 = xmem[i0]			# LN: 320 | 
	a0 - a1			# LN: 320 | 
	if (a >= 0) jmp (for_end_5)			# LN: 320 | 
cline_320_0:			/* LN: 322 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x105)			# LN: 322 | 
	i0 = xmem[i0]			# LN: 322 | 
	call (_cl_wavread_recvsample)			# LN: 322 | 
	i0 = i7 - (0x20e)			# LN: 322 | 
	xmem[i0] = a0h			# LN: 322 | 
cline_322_0:			/* LN: 323 | CYCLE: 0 | RULES: () */ 
	...
	i0 = a0			# LN: 323 | 
	i1 = i7 - (0x20c)			# LN: 323 | 
	i0 = i0 + (_sampleBuffer + 0)			# LN: 323 | 
	a0 = xmem[i1]			# LN: 323 | 
	a1 = i0			# LN: 323 | 
	a0 = a1 + a0			# LN: 323 | 
	AnyReg(i0, a0h)			# LN: 323 | 
	i1 = i7 - (0x20e)			# LN: 323 | 
	a0 = xmem[i1]			# LN: 323 | 
	xmem[i0] = a0h			# LN: 323 | 
cline_323_0:			/* LN: 320 | CYCLE: 0 | RULES: () */ 
init_latch_label_3:			/* LN: 324 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 320 | 
	a0 = xmem[i0]			# LN: 320 | 
	...
	xmem[i0] = a0h			# LN: 320 | 
	jmp (for_5)			# LN: 320 | 
cline_320_1:			/* LN: 318 | CYCLE: 0 | RULES: () */ 
init_latch_label_4:			/* LN: 325 | CYCLE: 0 | RULES: () */ 
for_end_5:			/* LN: 320 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20c)			# LN: 318 | 
	a0 = xmem[i0]			# LN: 318 | 
	uhalfword(a1) = (0x1)			# LN: 318 | 
	a0 = a0 + a1			# LN: 318 | 
	i0 = i7 - (0x20c)			# LN: 318 | 
label_end_93:			# LN: 318 | CYCLE: 5 | RULES: ()
	xmem[i0] = a0h			# LN: 318 | 
cline_318_1:			/* LN: 327 | CYCLE: 0 | RULES: () */ 
for_end_4:			/* LN: 318 | CYCLE: 0 | RULES: () */ 
	call (_processing_foo)			# LN: 327 | 
cline_327_0:			/* LN: 329 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20c)			# LN: 329 | 
	a0 = 0			# LN: 329 | 
	xmem[i0] = a0h			# LN: 329 | 
	do (0x10), label_end_94			# LN: 329 | 
cline_329_0:			/* LN: 331 | CYCLE: 0 | RULES: () */ 
label_begin_94:			/* LN: 329 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 331 | 
	a0 = 0			# LN: 331 | 
	xmem[i0] = a0h			# LN: 331 | 
for_7:			/* LN: 331 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 331 | 
	a0 = xmem[i0]			# LN: 331 | 
	i0 = i7 - (0x3)			# LN: 331 | 
	a1 = xmem[i0]			# LN: 331 | 
	a0 - a1			# LN: 331 | 
	if (a >= 0) jmp (for_end_7)			# LN: 331 | 
cline_331_0:			/* LN: 333 | CYCLE: 0 | RULES: () */ 
	...
	i0 = a0			# LN: 333 | 
	i1 = i7 - (0x20c)			# LN: 333 | 
	i0 = i0 + (_sampleBuffer + 0)			# LN: 333 | 
	a0 = xmem[i1]			# LN: 333 | 
	a1 = i0			# LN: 333 | 
	a0 = a1 + a0			# LN: 333 | 
	AnyReg(i0, a0h)			# LN: 333 | 
	i1 = i7 - (0x20e)			# LN: 333 | 
	a0 = xmem[i0]			# LN: 333 | 
	xmem[i1] = a0h			# LN: 333 | 
cline_333_0:			/* LN: 334 | CYCLE: 0 | RULES: () */ 
	...
	a0 = xmem[i1]			# LN: 334 | 
	i0 = xmem[i0]			# LN: 334 | 
	call (_cl_wavwrite_sendsample)			# LN: 334 | 
cline_334_0:			/* LN: 331 | CYCLE: 0 | RULES: () */ 
init_latch_label_5:			/* LN: 335 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 331 | 
	a0 = xmem[i0]			# LN: 331 | 
	...
	xmem[i0] = a0h			# LN: 331 | 
	jmp (for_7)			# LN: 331 | 
cline_331_1:			/* LN: 329 | CYCLE: 0 | RULES: () */ 
init_latch_label_6:			/* LN: 336 | CYCLE: 0 | RULES: () */ 
for_end_7:			/* LN: 331 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20c)			# LN: 329 | 
	a0 = xmem[i0]			# LN: 329 | 
	uhalfword(a1) = (0x1)			# LN: 329 | 
	a0 = a0 + a1			# LN: 329 | 
	i0 = i7 - (0x20c)			# LN: 329 | 
label_end_94:			# LN: 329 | CYCLE: 5 | RULES: ()
	xmem[i0] = a0h			# LN: 329 | 
cline_329_1:			/* LN: 316 | CYCLE: 0 | RULES: () */ 
init_latch_label_7:			/* LN: 337 | CYCLE: 0 | RULES: () */ 
for_end_6:			/* LN: 329 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20b)			# LN: 316 | 
	a0 = xmem[i0]			# LN: 316 | 
	...
	xmem[i0] = a0h			# LN: 316 | 
	jmp (for_3)			# LN: 316 | 
cline_316_1:			/* LN: 342 | CYCLE: 0 | RULES: () */ 
for_end_3:			/* LN: 316 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x105)			# LN: 342 | 
	i0 = xmem[i0]			# LN: 342 | 
	call (_cl_wavread_close)			# LN: 342 | 
cline_342_0:			/* LN: 343 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20a)			# LN: 343 | 
	i0 = xmem[i0]			# LN: 343 | 
	call (_cl_wavwrite_close)			# LN: 343 | 
cline_343_0:			/* LN: 346 | CYCLE: 0 | RULES: () */ 
	a0 = 0			# LN: 346 | 
	jmp (__epilogue_228)			# LN: 346 | 
cline_346_0:			/* LN: 347 | CYCLE: 0 | RULES: () */ 
__epilogue_228:			/* LN: 347 | CYCLE: 0 | RULES: () */ 
	i7 = i7 - (0x20e)			# LN: 347 | 
	i7 -= 1			# LN: 347 | 
	ret			# LN: 347 | 
...
cline_226_0:			/* LN: 228 | CYCLE: 0 | RULES: () */ 
	...
	x1 = ymem[i0]			# LN: 228 | 
	a0 = x1 * x0			# LN: 228 | 
	call (__laccum_sat_accum)			# LN: 228 | 
	i0 = i7 - (0x4)			# LN: 228 | 
...
cline_229_0:			/* LN: 231 | CYCLE: 0 | RULES: () */ 
	...
	x1 = ymem[i0]			# LN: 231 | 
	a0 = x1 * x0			# LN: 231 | 
	call (__laccum_sat_accum)			# LN: 231 | 
	i0 = i7 - (0x4)			# LN: 231 | 
...
cline_130_0:			/* LN: 131 | CYCLE: 0 | RULES: () */ 
	...
	x1 = xmem[i0]			# LN: 131 | 
	a0 = x0 * x1			# LN: 131 | 
	call (__laccum_sat_accum)			# LN: 131 | 
	i0 = i7 - (0x9)			# LN: 131 | 
...
cline_139_0:			/* LN: 140 | CYCLE: 0 | RULES: () */ 
	...
	a0h = xmem[i0]			# LN: 140 | 
	uhalfword(a0l) = (0x0)			# LN: 140 | 
	i0 = i7 - (0xb)			# LN: 140 | 
	a1g = xmem[i0]; i0 += 1			# LN: 140, 140 | 
	a1h = xmem[i0]			# LN: 140 | 
	uhalfword(a1l) = (0x0)			# LN: 140 | 
	a0 = a0 + a1			# LN: 140 | 
	i0 = i7 - (0x7)			# LN: 140 | 
...
cline_140_0:			/* LN: 142 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x7)			# LN: 142 | 
	b0g = xmem[i0]; i0 += 1			# LN: 142, 142 | 
	b0h = xmem[i0]			# LN: 142 | 
	uhalfword(b0l) = (0x0)			# LN: 142 | 
	b0 = b0 >> 1			# LN: 142 | 
